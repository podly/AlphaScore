# AlphaScore Serial Protocols

This document describes both serial protocols supported by AlphaScore: the
myPinballs Compatibility Protocol and the extended AlphaScore Protocol.
